...
#' @references https://arxiv.org/pdf/1808.09029.pdf
#' @param units Number of hidden units for each layer in the block
#' @param cell_type string denoting type of cell to use. default: `LSTM`
